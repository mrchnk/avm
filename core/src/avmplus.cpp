...
// to replace up to #include <core/avmplus.h> with avmplus.pch, the
// precompiled header.
...
// #include <core/avmplus.h> should be the first non-comment line in
// any CPP in this project, as the default will be to substitute
// the contents of the pch for everything up to the include.

// If a file cannot #include <core/avmplus.h>, or cannot include it
