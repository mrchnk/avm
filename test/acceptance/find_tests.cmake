function(find_tests_at add_function glob)
    ...
    file(RELATIVE_PATH target_name ${CMAKE_CURRENT_LIST_DIR} ${dir})
    if (target_name)
    ...
    foreach (test ${tests})
        ...
        elseif(add_function STREQUAL abs_add_test)
            abs_add_test(${args})
        elseif(add_function STREQUAL abc_add_test)
            abc_add_test(${args})
        else()
...
macro(abc_find_tests name glob)
    find_tests(${name} ${glob} abc_add_test *.abc_)
endmacro()
